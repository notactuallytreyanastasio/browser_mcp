...
${notes}`;
            ...
            throw new DatabaseError(`Error querying links: ${error.message}`, error);
        }
    }
    async curateLink(args) {
        ...
        try {
            ...
            throw new DatabaseError(`Error curating link: ${error.message}`, error);
        }
    }
...
Selected links span ${new Set(diverseLinks.map(l => l.source_site)).size} different sources.`
            ...
            throw new DatabaseError(`Error generating bag of links: ${error.message}`, error);
        }
    }
...
Click any tag to see associated links!`
            ...
            throw new DatabaseError(`Error generating tag cloud: ${error.message}`, error);
        }
    }
